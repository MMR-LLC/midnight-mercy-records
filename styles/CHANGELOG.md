...
## v2.6.3 — Separate YouTube Destinations

- Keeps the header YouTube icon linked to Ashan Levi's regular YouTube channel.
- Keeps the dedicated YouTube Music card linked to Ashan Levi's YouTube Music profile.
- Removes the duplicate regular YouTube card from the Listen Everywhere section.
